...
@Component({
  selector: 'app-rewards-requests',
  templateUrl: './rewards-requests.component.html',
  styleUrls: ['./rewards-requests.component.scss']
})
export class RewardsRequestsComponent implements OnInit {
